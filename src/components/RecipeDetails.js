...
export default class RecipeDetails extends Component{
   /* constructor(props){
        ...
        this.state={
            recipe:recipe,
            url:`https://www.food2fork.com/api/get?key=b0c4fea740ec467720348837694c1641&rId=${this.props.id}`
        }
    }
    ...
    async componentDidMount(){
        ...
        const url=`https://www.food2fork.com/api/get?key=b0c4fea740ec467720348837694c1641&rId=${id}`;
        try{
